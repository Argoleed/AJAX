...
<script>
    ...
    function add_channel(){
        ...
        let type = confirm("Сделать канал приватным?");
        if (type == true){
            type = "private";
        }
        else{
    ...
    function delete_permission(user){
        $.ajax({
            url: "ajax/delete_permission.php",
            type: "POST",
            cache: false,
        ...
        <div class="row">
            ...
            <div class="col-7"><br><br>
                ...
                <form class="btn-group container-fluid">
                    ...
                    <button type="button" id="send" class="btn btn-success" onclick="send_message()">Отправить</button>
                </form>
            </div>
            <div class="col"><br><br>
